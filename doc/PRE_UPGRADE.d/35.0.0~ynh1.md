If you are upgrading to a **new major version** of Nextcloud (e.g. 34, 35), **please make sure that your Nextcloud apps are up to date** from Nextcloud's administration panel beforehand.

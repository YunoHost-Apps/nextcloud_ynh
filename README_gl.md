...
**Versión proporcionada:** 29.0.14~ynh1
...
Envía a túa colaboración á [rama `oldstable`](https://github.com/YunoHost-Apps/nextcloud_ynh/tree/oldstable).

Para probar a rama `oldstable`, procede deste xeito:
